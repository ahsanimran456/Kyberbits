  ...
  return (
    (<svg
      ...
      <path
        ...
        style={{
          fill: "#68676A",           // Fill color
          stroke: "#636264",     // Border color
          strokeWidth: "0.05px", // Ultra-thin border
        }}
      />
      <path
      ...
      {/* <path
        ...
        style={{
          fill: "#262626",    // Dark fill color
          stroke: "#636264",  // Border color
          strokeWidth: "0.3px" // Extremely thin border
        }}
      /> */}
      <path
        opacity="0.5"
